 d3.xhr2 = function(url, method, params, mime, callback) {
  ...
  function ActualizarVehiculo() {
    var placa = d3.select("#placa").property("value");
    var ruta = d3.select("#ruta").property("value");
    ...
    var params = "placa="+placa+"&ruta="+ruta+"&calle="+calle+
                 "&avenida="+avenida+"&distancia="+distancia+"&longitud="+longitud+
                 "&latitud="+latitud+"&razon_social="+razon_social;
    d3.xhr2("http://localhost:8089/rest/vehiculos/"+placa,"PUT",params,function(json) {
    });
    ListadoVehiculos();
  }